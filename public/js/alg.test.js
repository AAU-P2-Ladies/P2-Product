...
describe('indexStudents', () => {
    test('should give index to students object', () => {
        //const output = new main.Student(["Sina",    0, [2,0,5], [2], [1,2]   -1, [0,5]])
            
        //expect(helper.indexStudents(student1)[0].index).toEqual(0)
